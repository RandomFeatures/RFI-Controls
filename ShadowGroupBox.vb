...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        For iLoop = 0 To Me.Controls.Count - 1
            ...
            If (MyShadowControl.Tag = 2142) Or _
               ...
               MyShadowControl.Tag <> 2412) Then
                ...
                'CType(Me.Controls.Item(iLoop), TextBox)
                'CType(MyShadowControl, RichControl).BorderStyle = BorderStyle.FixedSingle
        ...
        Next
        LocalPen.Dispose()
        '  e.Graphics.DrawString("TEST", Font, New SolidBrush(BackColor), x, y)
        ' e.Graphics.DrawString("TEST", Font, New SolidBrush(ForeColor), x + 1, y + 1)
